<?php if ( ! defined( 'ABSPATH' ) ) exit;
	/**
		* Admin Page Class
		*
		* @package     Social_Subscriber_ADMIN_LINKS
		* @subpackage  
	...
	*/
	...
	class Social_Subscriber_ADMIN {	
		...
		function plugin_admin_style_script() {
			...
			wp_enqueue_style( $this->slug.'-style', $this->plugin_url . 'admin/css/style.css',false, $this->version);wp_enqueue_script($this->slug.'-script', $this->plugin_url . 'admin/js/script.js', array('jquery'), $this->version);			
		...
		public function admin_messages(){			
			if ( isset( $_GET['ss-message'] ) && 'update' == $_GET['ss-message']) {				
				add_settings_error( 'ss-notices', 'ss-option-update', 'Settings updated.', 'updated' );
			}
			
			settings_errors( 'ss-notices' );
		}
