<?php if ( ! defined( 'ABSPATH' ) ) exit;		
	$tab_menu = array(
		'social_networks'  => array('Social Networks', 'fa-users'),
		'style'            => array('General Style', 'fa-paint-brush'),
	...
	<div class="wowcolom">
		<div id="wow-leftcol">			
			<div class="menu-box wow-admin">
				<ul class="menu-nav">
					<?php 						
						$m_current = (isset($_GET['menu'])) ? sanitize_text_field($_GET['menu']) : 'social_networks';
		...
		<div id="wow-rightcol">
			...
			<div class="wowbox">
				...
				<div class="wow-admin" style="display: block;">
					<div class="wow-admin-col">						
						...
						You can use shortcode for the display of the social subscribe in the contents of a posts and pages.<p />
						<center><b>[SSuscriber social="facebook"]</b></center><p />
						Attributes:<p/>						
						<b>text</b> - text of subscribe button<p/>
						<b>redirect</b> - URL of redirect, where user redirected after subscribe. If this attribute empty, user will be redirected to current page<p/>
						Example:<p/>
						<center><b>[SSuscriber social="facebook" text="Subscribe" redirect="https://wow-estore.com/"]</b></center>
			...
			<div class="wowbox">
				...
				<div class="wow-admin wow-plugins">
					<p>We will be very grateful if you <a href="https://wordpress.org/plugins/social-subscriber/" target="_blank"><b>leave a review about the plugin</b></a>.</p>
